...
(function(w){
    ...
    legend.prototype = {
        init: function(){
            ...
            element.style.cssText = " position: relative; width: 256px; padding: 10px; background: transparent; display:none;";
            element.id="heatmap_legend"; 
            element.innerHTML = "<label class='x-component x-form-item x-form-item-label x-component-default heatmap_label'>"+title+"</label>";
    ...
    heatmap.prototype = {
        configure: function(config){
               ...
               // me.set("gradient", config.gradient || { 0.45: "rgb(0,0,255)", 0.55: "rgb(0,255,255)", 0.65: "rgb(0,255,0)", 0.95: "yellow", 1.0: "rgb(255,0,0)"});    // default is the common blue to red gradient
                ...
                me.set("gradient", config.gradient || { 0.60: "#FFC200", 0.65: "#FF7E00", 0.70: "#FF3100",  0.75: "#FF0000", 0.80:"#D22424"});
                // me.set("gradient", config.gradient || { 0.20: "rgb(255, 255, 1)", 0.30: "#F2D50F", 0.40: "#FAC769",0.80: "#FABB6C", 
                //                                          0.95: "#FD1205", 1.0: "#C30F0F"});    // Option 2
